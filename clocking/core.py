...
def get_whole_year(database, user, year, holiday=False, disease=False, extraordinary=False):
...
def get_whole_month(database, user, year, month, holiday=False, disease=False, extraordinary=False):
