...
def test_configuration():
    ...
    assert get_current_configuration(TEMP_DB, "test") == (
        1,
        1,
        "test",
        "Italy Office",
...
# --------------------------------------------------
def test_print_configurations(capsys):
...
+----+--------+------+--------------+-------------+-------------+---------------------+---------------+--------------+---------+---------+----------+-------------+----------------------+-------------+-------------+--------------+
| 1  |   1    | test | Italy Office |      X      |     8.0     | Mon Tue Wed Thu Fri |      0.5      |     1.0      | disease | holiday |    €     |     7.5     |         8.5          |     0.0     |     0.0     |     8.0      |
+----+--------+------+--------------+-------------+-------------+---------------------+---------------+--------------+---------+---------+----------+-------------+----------------------+-------------+-------------+--------------+
"""
    )
...
def test_print_table_holiday(capsys):
    ...
    assert insert_working_hours(
        TEMP_DB, user, date="2023:08:15", holiday="All at the beach!"
    )
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023:09:16", holiday=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
"""
    ...
    print_working_table(
        get_whole_month(TEMP_DB, user, year=2023, month=9, holiday=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
def test_print_table_disease(capsys):
    ...
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023:09:16", disease=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
"""
    ...
    print_working_table(
        get_whole_month(TEMP_DB, user, year=2023, month=9, disease=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
def test_print_table_extraordinary(capsys):
    ...
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023:09:16", extraordinary=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
"""
    ...
    print_working_table(get_whole_year(TEMP_DB, user, year=2023, extraordinary=True))
    captured = capsys.readouterr()
    assert (
        captured.out
        == """+----------+------+-------+-----+-------+-------------+----------+---------------+--------------+-------------+---------+---------+
...
"""
    ...
    print_working_table(
        get_whole_month(TEMP_DB, user, year=2023, month=9, extraordinary=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
def test_print_table_permit(capsys):
    ...
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023:09:16", permit_hours=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
"""
    ...
    print_working_table(get_whole_year(TEMP_DB, user, year=2023, permit_hours=True))
    captured = capsys.readouterr()
    assert (
        captured.out
        == """+----------+------+-------+-----+-------+-------------+----------+---------------+--------------+-------------+---------+---------+
...
"""
    ...
    print_working_table(
        get_whole_month(TEMP_DB, user, year=2023, month=9, permit_hours=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
def test_print_table_other(capsys):
    ...
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023:09:16", other_hours=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
"""
    ...
    print_working_table(
        get_whole_month(TEMP_DB, user, year=2023, month=9, other_hours=True)
    )
    captured = capsys.readouterr()
    assert (
        captured.out
...
def test_print_rewards(capsys):
    ...
    # Print date
    print_working_table(
        get_working_hours(TEMP_DB, user, date="2023.22.08"),
...
"""
    ...
    with raises(ValueError):
        print_working_table(
            get_working_hours(TEMP_DB, user, date="2023.22.08"), rewards=(None, None)
        )
        print_working_table(
            get_working_hours(TEMP_DB, user, date="2023.24.08"),
            rewards=get_current_configuration(TEMP_DB, "test"),
        )
...
def test_save_table():
    ...
    assert os.path.exists(my_working_file)
    assert (
        save_working_table(get_whole_year(TEMP_DB, user, year=2023), my_working_file)
        is None
    )
    assert os.path.exists(my_working_file)
    assert (
        save_working_table(
            get_whole_month(TEMP_DB, user, year=2023, month=9), my_working_file
        )
        is None
    )
    assert save_working_table(get_all_days(TEMP_DB, user), my_working_file) is None
    assert os.path.exists(my_working_file)
...
def test_delete_values():
    ...
    assert insert_working_hours(TEMP_DB, user, 8, date="2023-02-08")
    assert delete_working_hours(TEMP_DB, user, day="8", month="2", year="2023")
